...
<footer className="bg-dark text-center text-white">
  <div className="container p-4 d-flex justify-content-center align-items-center gap-8">

  <div className="flex flex-row items-center justify-center lg:justify-center mb-20 w-25">
                  <p className="text-lg mb-0 mr-4">Ssiguenos</p>
                  <button
                    type="button"
    ...
    <section className="w-25 ">
      ...
      <form action="">
        <div className="row d-flex justify-content-center">
          ...
          <p className="text-center pl-10 mb-2">
              <strong className="w-full text-center">Escribenos...</strong>
            </p>
          ...
          <div className="col-auto">
          <input type="email" id="form5Example21" className="form-control " placeholder="Your Email..." />
          <button type="submit" className="btn btn-outline-light mt-4 w-100">
              Unirse
            </button>
          </div>
        </div>

...
window.location.href = '/home'
  ...
  return (
    ...
    <div className="flex bg-gradient-to-r from-gray-100 to-gray-300	 h-screen		justify-center items-center">


      <section id="sct" className="	 h-screen  h-96	rounded-lg bg-white  xm:flex flex-col min-w-800	md:min-w-700 lg:min-w-700	drop-shadow-2xl">
        ...
        <div className="px-6 h-full text-gray-800 bg-white ">
          ...
          >
            ...
            <div id="pc" className="md:shrink-0  basis-auto xl:w-96 h-64	">
